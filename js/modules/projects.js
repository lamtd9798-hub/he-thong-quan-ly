import {refs,arr,ts,logActivity,can,esc,norm,fmtDate,TENDER_STAGES,DISCIPLINES,stageInfo,projectCode,setPage,loading,empty,badge,modal,toast,confirmBox} from "../core.js?v=2.8.0";
